...
const menus = {
    ...
    "Спеціальності": "<b align='center'>152 «Метрологія та інформаційно-вимірювальна техніка»</b> \n\nІнтелектуальні інформаційні вимірювальні системи  -  студентам надають знання з проектування вимірювальних систем промислового призначення; структури і побудови інформаційно-діагностичних систем; основ автоматизації експериментальних досліджень, патентного пошуку та захисту інтелектуальної власності, основ наукових досліджень, організації та управління виробництвом. \n\nМенеджмент якості товарів та послуг  -  студенти вивчають найсучасніші методи, принципи і вимоги до управління якістю товарів і послуг, серед яких: \nсхеми безперервного удосконалення (PDCA, MAIC, DMAIC, RDMAIC, RDMAICSI тощо); \nсучасні інструменти управління якістю і контролю якості; \nконцепції бездефектної роботи і ощадливого управління: 6σ method; Lean management; Lean 6σ тощо; \nякість в управлінні проектами (Quality inproject management); \nправила європейської сертифікації і оцінки відповідності товарів, послуг і систем менеджменту, правила акредитації випробувальних лабораторій; \nпідходи до управління ризиками і реалізації можливостей. \n\n<b align='center'>152 153 «Мікро- та наносистемна техніка»</b> \n\nМікро- та наносистемна техніка  -  здійснюється підготовка фахівців з розробки, виробництва комп’ютерного моделювання та дослідження пристроів, матеріалів і компонентів мікро- та наноелектроніки різного призначення.",
    "Контакти": "",
    "Працевлаштування": "",
